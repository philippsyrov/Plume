...
- Artifact source head: `91d30e5c5e4fa2112ac6fa27a7e4f516a89cbb84`
...
- Final DMG SHA-256:
  `518c59cadd42ff50156bee83a093ea69344ee502ceef82b195420f8619c1eb75`
...
The artifact source head is the rebased product commit and includes the bounded
MLX SSE and Ollama NDJSON streaming-frame work from `59a4e51`. Four focused
frame-cap tests passed (oversized rejection and exact-boundary acceptance for
both adapters), followed by the full verifier at 39 pass and 0 fail.
...
- project-memory creation and explicit Library attachment;
...
The app and DMG were rebuilt after rebasing onto the integrated streaming head.
The evidence-only documentation commit that follows does not enter the
application bundle. Its exact PR head is recorded in the review handoff before
the DMG is uploaded.
