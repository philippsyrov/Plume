...
[
  ...
  },
  {
    ...
    "status": "scaffold",
    "currentBehavior": "Schema v5 and main-webview-only browser.workspaceLoad/Save/Reset persist bounded per-session layout, tabs, and admitted top-level restoration history in physically separate local/project session stores. Corrupt Browser rows reset without transcript loss; fork/rewind start empty; local evidence is app-private, session-owned, and removed through a tombstone-backed composite delete.",
    ...
    "lastVerifiedCommit": "133b6fe6f68ecab2f72561ff5112da9ac42cabfe",
    "lastVerifiedDate": "2026-07-14"
  },
  {
