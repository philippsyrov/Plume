...
| Durable Home conversation | partial | Local startup and ordinary projectless chat open into one backend-owned Home conversation in app-private storage. | Route Browser and Library ownership through Home, then record the packaged relaunch smoke. |
