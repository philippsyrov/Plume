...
| Conversation export | shipped | One conversation exports explicitly through the native Markdown save panel; failures remain visible and storage-cap recovery directs the user to the row-menu action. | Record the packaged export smoke. |
...
[
  ...
  },
  {
    ...
    "backendReachability": "sessions.storage reports usedBytes/warnBytes/capBytes for the scope named in the payload; sessions.saveTranscript, sessions.fork, and sessions.rollback refuse with IpcError::StorageFull. The save leg is covered end to end. The branch leg has a test-only lower-cap seam that proves a real over-cap fork returns StorageFull and rolls back both the child row and its allocated pages; a separate regression proves deferred FTS5 pages are flushed before the decision.",
    "automatedEvidence": [
  ...
  },
  {
    ...
    "missingBehavior": "No packaged export smoke is recorded.",
    "frontendReachability": "Export is available from the session row menu in both shells; the storage-cap recovery notice directs the user there, and write failures remain visibly distinct from cancellation.",
    ...
    "nextCommissionedSlice": "Keep export explicit and local; record the packaged export smoke",
    "lastVerifiedCommit": "90e07d3a608adf6f3df524e9ec9dc98984d1e838",
    "lastVerifiedDate": "2026-08-30"
  },
  {
    ...
    "lastVerifiedCommit": "283ffbcaa7e9d7fbdd48bc4a1fc12fc1212b50ce",
    "lastVerifiedDate": "2026-08-30"
  },
  {
