...
| 51 | Click `Clear` on the chat panel | Transcript empties; input returns to ready state. Preview stays visible (clearing transcript doesn't clear chip). |
| 52 | Click `Close` | App returns to the open form. |
