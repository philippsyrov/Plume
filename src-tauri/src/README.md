...
| Native Apple Foundation Models helper | `src-tauri/apple-model/Sources/PlumeAppleModel/` | No Tauri IPC yet; Task 5 owns helper spawning, availability, cancellation, and chat routing | `src-tauri/apple-model/Tests/PlumeAppleModelTests/` via `swift test --package-path src-tauri/apple-model` | [`docs/superpowers/specs/2026-07-17-apple-qwen-model-onboarding-design.md`](../../docs/superpowers/specs/2026-07-17-apple-qwen-model-onboarding-design.md) |
