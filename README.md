...
evidence viewer, and a typed explicit context shelf with exact prompt manifests.
The bounded agent loop, semantic retrieval, Browser execution, computer-use
emission, and broad tool execution are not shipped.
